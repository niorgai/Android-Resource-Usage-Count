...
class ResourceUsageCountUtils {
    ...
    /**
     * current just count xml file
     */
    static boolean isTargetFileToCount(VirtualFile file) {
        return file != null && !TextUtils.isEmpty(file.getPath()) && file.getPath().endsWith(".xml");
    }
